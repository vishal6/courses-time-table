...
CREATE  TABLE IF NOT EXISTS `System_Status` (
  ...
  `Current_Year` YEAR NOT NULL COMMENT 'the system current year' ,
  ...
  PRIMARY KEY (`Current_Year`) )ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='contains the current state of the system';
...
(12345, 'algorithm', 10, 14, 12, 2210, 1995);
...
CREATE TABLE IF NOT EXISTS `person` (
  ...
  `Mail` varchar(50)  COMMENT 'Person mail',
